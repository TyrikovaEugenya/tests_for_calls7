...
class TestKambekfilmUserFlow(BaseUserFlowTest):
    BASE_URL = "https://kambekfilm.ru"
    SELECTORS = config.SELECTORS
    DOMAIN_NAME = "kambekfilm"

    # Chromium-тест с Lighthouse
